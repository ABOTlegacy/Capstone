<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Survey.aspx.cs" Inherits="Entity_Manager" %>
        ...
        <div class="fieldHalfsRight">
            <div style="display: inline-block; ">
                ...
                <div class="rightOptionsAdd addBox">
                    <h2>Revision</h2>
                    <asp:Label ID="lblAdd1" Text="Revision Number" runat="server" /><br />
                    <asp:TextBox ID="txtAddRevisionNumber" style="width: 100%;" runat="server" /><br />
                    <asp:Label ID="lblAdd2" Text="Active" runat="server" />
                    <asp:CheckBox ID="chkAddActive" style="width: 100%;" runat="server" /><br />
                    <div id="btnAdd"><asp:Button ID="btnAdd" Text="Add Revision" onclick="Add_Click" runat="server" /></div>
                </div>
