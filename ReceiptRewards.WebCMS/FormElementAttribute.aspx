<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormElementAttribute.aspx.cs" Inherits="Entity_Manager" %>
...
<div id="MainCenter">
    ...
    <form id="form1" runat="server">
        ...
        <div class="fieldHalfsLeft">
            ...
            <asp:DropDownList ID="ddlEditFormElementAttributeType" runat="server" /><br />
            <asp:Label ID="lblEdit2" Text="Test Data" runat="server" /><br />
            <asp:TextBox ID="txtEditFormElementAttributeValue" runat="server" style="width: 100%;" /><br />
        </div>
