<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommandIdentifier.aspx.cs" Inherits="Entity_Manager" %>
...
<div id="MainCenter">
    ...
    <form id="form1" runat="server">
        ...
        <div class="fieldHalfsLeft">
            ...
            <asp:DropDownList ID="ddlEditIdentificationType" runat="server" /><br />
            <asp:Label ID="lblEdit2" Text="Test Data" runat="server" /><br />
            <asp:TextBox ID="txtEditIdentificationValue" runat="server" style="width: 100%;" /><br />
        </div>
