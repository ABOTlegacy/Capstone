...
namespace ReceiptRewards.Droid2 {
    ...
    /**
     * Most of this code was taking from @CheeseBaron's example for the Dashboard. Code just works.
     */
    ...
    public class DrawerAdapter: ActionBarDrawerToggle {
        public DrawerAdapter(Activity activity, DrawerLayout drawerLayout, int drawerImageRes, int openDrawerContentDescRes, int closeDrawerContentDescRes) : base(activity, drawerLayout, drawerImageRes, openDrawerContentDescRes, closeDrawerContentDescRes) { }
